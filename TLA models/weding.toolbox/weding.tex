...
\@x{}\moduleLeftDash\@xx{ {\MODULE} weding}\moduleRightDash\@xx{}%
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jan} 23
 17:42:14 \ensuremath{EET} 2021 by macro
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jan} 18
 22:57:04 \ensuremath{EET} 2021 by macro
\end{cpar}%
\end{lcom}%
\end{document}
