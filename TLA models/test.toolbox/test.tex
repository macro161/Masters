...
\@x{ {\VARIABLES} i ,\, pc}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq} ( pc \.{=}\@w{start} ) \.{\land} ( i \.{=} 0 )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor}\@s{4.1} \.{\land} pc \.{=}\@w{start}}%
\@x{\@s{55.04} \.{\land} i \.{'}\@s{2.87} \.{\in} 0 \.{\dotdot} 1000}%
\@x{\@s{55.04} \.{\land} pc \.{'} \.{=}\@w{middle}}%
\@x{\@s{39.83} \.{\lor}\@s{4.10} \.{\land} pc \.{=}\@w{middle}}%
\@x{\@s{55.04} \.{\land} i \.{'}\@s{2.87} \.{=} i \.{+} 1}%
\@x{\@s{55.04} \.{\land} pc \.{'} \.{=}\@w{done}}%
\@pvspace{24.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jan} 18 21:30:41 \ensuremath{EET} 2021 by macro
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} \ensuremath{Jan} 18
 21:22:42 \ensuremath{EET} 2021 by macro
\end{cpar}%
\end{lcom}%
\end{document}
