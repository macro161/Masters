...
TLA\textsuperscript{+} kalba yra skirta kurti konkurencinių ir išskirstytų sistemų formalias specifikacijas ir jas verifikuoti.
	...
	Šias savybes mes galime patikrinti naudodamiesi TLC Model Checker (modelio tikrintoju).
		...
		Yra skirtingų būdų patikrinti ar specifikacija atitinka realizacija: specifikacijos ir realizacijos rašymas ta pačia programavimo kalba \cite{kern1999formal}, programinio kodo generavima naudojantis specifikacija \cite{houhou2017framework}, testų generavimas naudojant specifikaciją \cite{utting2010practical}.
		Mūsų darbo atveju šie metodai netika, nes realizuotas kodas jau bus parašytas Apache Kafka kūrėjų, o testų generavimas išskirstytos sistemos algoritmui būtų perdaug sudėtingas dėl nedeterministionio algoritmo veikimo laiko atžvilgiu \cite{davis2020extreme}.
		Dėl šių priežasčiu rinksimės kitą formalaus verifikavimo metodą -- Modeliu paremta pėdsakų tikrinimą (angl. {\it Model-Based Trace-Checking}) metodu \cite{howard2011modelbased}.
		...
		Šis metodas mums leis patikrinti algoritmo sukurtus pėdsakus po programos vykdymo išvengiant nedeterministinio algoritmos vykdymo kuris dažniausiai kyla išskirstytose sistemose, kuomet skirtingi mazgai baigia darbą nevienodu metu.
